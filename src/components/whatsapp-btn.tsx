import { COMPANY_WHATSAPP_NUMBER } from "@/data/constants";
...
export default function WhatsAppBtn() {
  return (
    <a
      ...
      href={`https://wa.me/${COMPANY_WHATSAPP_NUMBER}?text=Hello%2C%20I%27d%20like%20to%20inquire%20about%20your%20removal%20services`}
      target="_blank"
    ...
    >
      ...
      {/* Alternative: Text label that appears on hover - uncomment if preferred */}
      ...
      <div className="pointer-events-none opacity-0 group-hover:opacity-100 transition-all duration-300 absolute -left-36 top-1/2 -translate-y-1/2">
        <div className="bg-white text-gray-900 px-4 py-2 rounded-lg shadow-xl border border-gray-200 whitespace-nowrap">
          <p className="text-sm font-semibold">Need help? Chat now!</p>
